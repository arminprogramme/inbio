        ...
        return (
            <div className={'todo items-center grid grid-cols-5  shadow-lg my-3 rounded '  + (this.props.completed ? 'completed' : null)}>
                ...
                <div className="check-todo text-center w-full">
                    <button className='bg-green-500 h-full w-full  py-2' onClick={this.checkHandler.bind(this , this.props.id)}>Complete</button>
                </div>
                <div className="delete-todo text-center">
                    <button className='bg-red-500 h-full w-full  py-2' onClick={this.removeHandler.bind(this , this.props.id)}>Remove</button>
                </div>
            </div>
        );
    }
