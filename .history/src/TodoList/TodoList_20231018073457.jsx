...
class TodoList extends Component {
    ...
    clickHandler = () => {
       let newTodo = {id : this.state.todo.length +1 , completed : true , title : this.state.todoTitle}
    ...
    render() {
        return (
            <div>
                <Header/>
                <div className={"inputs-todo grid grid-cols-2 justify-center text-center my-5" + (this.props.completed ? 'completed' : null)}>
