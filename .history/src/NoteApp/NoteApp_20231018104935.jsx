...
class NoteApp extends Component {
    ...
    constructor(props){
        ...
        this.state = {
            colors : ['#ddd' , '#ffd37f' , '#fffa81' , '#d5fa80' , '#78f87f' , '#78fbd6' , '#79fdfe' , '#7ad6fd' , '#7b84fc' , '#d687fc' , '#ff89fd'],
            notes : [],
            inputColor : '',
            noteTitle : ''
        }
            ...
            <div>
                ...
                <div className="main-note-app my-10">
                    <div className="input-note-app">
                        <input type="text" style={{backgroundColor : this.state.inputColor}} className='w-full py-2 px-2 rounded shadow' value={this.state.noteTitle} />
                    </div>
