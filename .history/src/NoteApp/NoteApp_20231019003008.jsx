...
class NoteApp extends Component {
    ...
    noteClickHandler = (userID) => {
        ...
        let indexNotes = newNoteList.findIndex(note => {
            return note.id === userID
        })

        newNoteList.splice(indexNotes , 1)
        this.setState({
            notes : newNoteList
        })
    }
            ...
            <div>
                ...
                <div className="main-note-app my-10">
                    ...
                    <div className="button-note-app flex justify-end">
                        ...
                        <button onClick={(event) => this.removeAllHandler(event)} className='mx-1 font-bold text-white py-2 bg-red-500 px-3 rounded'>Remove</button>
                    </div>
                </div>
